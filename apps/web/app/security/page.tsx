...
export default async function SecurityPage() {
  ...
  return <AppShell><div className="page-container threat-page"><PageHeading
    eyebrow={snapshot.mode === "fixture" ? "Synthetic IAM intelligence" : "Tenant IAM intelligence"}
    title="Attack paths and threat workspace"
    description="Prioritize ways an identity could reach powerful access, inspect every configured step, and record the decision. Possibilities are inferred; activity is never invented."
